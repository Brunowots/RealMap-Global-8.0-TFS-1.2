...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "rebel") then
		npcHandler:say({
			'All rebels were brought to the giant castle. Guarded by the Red Legion, ... ',
	...
	elseif msgcontains(msg, "friends") then
		npcHandler:say({
			'The king\'s sister was pretty upset about the situation there but her brother ... ',
	...
	elseif msgcontains(msg, "plan") then
		npcHandler:say({
			'She ordered her loyal druids and hunters to disguise themselves ... ',
			'... as orcs from the near ISLAND and to ATTACK the Red Legion by night over and over again.'
		}, cid)
	elseif msgcontains(msg, "stroke") then
		npcHandler:say({
			'Most of the Red Legion went to the island by night. The orcs ... ',
			'... were not prepared and the Red Legion killed hundreds of orcs ... ',
			'... with nearly no loss. After they were satisfied they WALKED BACK to the castle.'
		}, cid)
	elseif msgcontains(msg, "walked back") then
		npcHandler:say({
			'It is said that the orcish shamans cursed the Red Legion. ',
			...
			'The orcs and many allied cyclopses and minotaurs from all ...',
			'... over Tibia came to avenge their friends, and they killed nearly all ... ',
			'... workers and soldiers in the castle. The HELP of the king\'s sister came too late.'
		}, cid)
	elseif msgcontains(msg, "help") then
		npcHandler:say({
			'She tried to rescue the workers but it was too late. The orcs ... ',
			'... started immediately to attack her troops, too. Her royal troops ... ',
			'... went back to the city. A TRICK saved the city from DESTRUCTION.'
		}, cid)
	elseif msgcontains(msg, "destruction") then
		npcHandler:say({
			'They used the same trick as against the Red Legion and the orcs ... ',
			'... started to fight their non-orcish-allies. After a bloody long fight ... ',
			'... the orcs went back to their cities. The city of Carlin was rescued. ',
			'Since then, a woman has always been ruling over Carlin and this statue ... ',
			'... was made to remind us of their great tactics against the orcs ... ',
