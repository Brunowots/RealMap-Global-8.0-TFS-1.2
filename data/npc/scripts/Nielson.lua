...
local function addTravelKeyword(keyword, cost, destination)
	local travelKeyword = keywordHandler:addKeyword({keyword}, StdModule.say, {npcHandler = npcHandler, text = 'Do you want to sail to ' .. string.titleCase(keyword) .. ' for |TRAVELCOST|?', cost = cost, discount = 'postman'})
