...
local function addTravelKeyword(keyword, cost, destination)
	local travelKeyword = keywordHandler:addKeyword({keyword}, StdModule.say, {npcHandler = npcHandler, text = text or 'So you wish for a trip to ' .. string.titleCase(keyword) .. '? |TRAVELCOST|?', cost = cost, discount = 'postman'})
